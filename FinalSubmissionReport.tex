...
\begin{itemize}
    ...
    \item \textbf{Relational Excellence:} I designed a normalized database structure that is fully extensible for future multi-vendor integrations.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Architectural Integrity:} By enforcing a strict 3NF database schema and a layered MVC structure, I built a foundation that is technically prepared for future multi-vendor scaling.
