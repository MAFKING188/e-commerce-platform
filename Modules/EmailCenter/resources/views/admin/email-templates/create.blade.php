@section('title', 'Create Email Template | LUWI Admin')
...
<div class="pc-wrap-narrow">
    ...
    <div class="pc-header">
        <div>
            ...
            <h1 class="pc-title">New Email Template</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.email-templates.store') }}" method="POST">
            ...
            <div class="pc-form-grid">
                <div class="pc-field">
                    ...
                    <input id="name" type="text" name="name" class="pc-field__input" value="{{ old('name') }}" placeholder="e.g. Newsletter — LUWI Digest" required>
                    @error('name')
            ...
            <div class="pc-form-grid">
                <div class="pc-field">
                    ...
                    <input id="subject" type="text" name="subject" class="pc-field__input" value="{{ old('subject') }}" placeholder="e.g. This Week's Curated Finds" required maxlength="150">
                    @error('subject')
                        <span class="pc-field__error">{{ $message }}</span>
                    @enderror
                </div>
...
Regards,<br>
The SmartShop Team">{{ old('body_markdown') }}</textarea>
            ...
            <div class="pc-form-actions">
                <button type="submit" class="btn btn-primary pc-btn-sm">Create Template</button>
