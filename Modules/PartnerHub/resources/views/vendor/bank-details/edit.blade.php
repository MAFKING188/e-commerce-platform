...
<div class="pc-header">
    <div>
        ...
        <p class="pc-subtitle">Update your bank details for customer payments.</p>
    </div>
</div>

<form action="{{ route('vendor.bank-details.update', $bankDetail) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="pc-card" style="margin-top: 1.5rem;">
        ...
        <div class="pc-card__body">
            <div class="pc-field pc-field--checkbox">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $bankDetail->is_active) ? 'checked' : '' }}>
