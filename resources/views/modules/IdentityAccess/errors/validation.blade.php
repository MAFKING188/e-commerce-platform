{{-- Identity Access: Validation Error --}}
<div class="error-panel" style="background: #1e293b; color: #c5c6c7; max-width: 500px; padding: 2rem; border-radius: 12px; margin: 0 auto;">
    ...
    <a href="/" style="display: block; width: fit-content; margin: 1.5rem auto 0; background: #3b82f6; color: white; padding: 0.75rem 1.5rem; border-radius: 12px; text-align: center; text-decoration: none;">
        Return to Home
    </a>
</div>