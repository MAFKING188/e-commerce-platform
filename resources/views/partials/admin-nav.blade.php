<div style="background: var(--surface-100); border: 1px solid var(--border); border-radius: 1.5rem; padding: 0.5rem; display: flex; gap: 0.5rem; margin-bottom: 3rem; overflow-x: auto; white-space: nowrap;">
    ...
    <a href="{{ route('products.index') }}" class="btn {{ request()->routeIs('products.*') ? 'btn-primary' : 'btn-ghost' }}" style="padding: 0.75rem 1.5rem;">Inventory</a>
    <a href="{{ route('users.index') }}" class="btn {{ request()->routeIs('users.*') ? 'btn-primary' : 'btn-ghost' }}" style="padding: 0.75rem 1.5rem;">Members</a>
    <a href="{{ route('vendors.index') }}" class="btn {{ request()->routeIs('vendors.*') ? 'btn-primary' : 'btn-ghost' }}" style="padding: 0.75rem 1.5rem;">Supply Chain</a>
    ...
    <a href="{{ route('categories.index') }}" class="btn {{ request()->routeIs('categories.*') ? 'btn-primary' : 'btn-ghost' }}" style="padding: 0.75rem 1.5rem;">Categories</a>
</div>
