...
<nav class="pc-nav" aria-label="Admin console">
    ...
    <a href="{{ route('admin.contacts.index') }}" class="pc-nav__tab {{ request()->routeIs('admin.contacts.*') ? 'is-active' : '' }}">
        <svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
        Contacts
    </a>
    <a href="{{ route('admin.email-templates.index') }}" class="pc-nav__tab {{ request()->routeIs('admin.email-*') ? 'is-active' : '' }}">
        <svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
        Email Center
    </a>
    <a href="{{ route('admin.audit-logs.index') }}" class="pc-nav__tab {{ request()->routeIs('admin.audit-*') || request()->routeIs('admin.outbound-*') ? 'is-active' : '' }}">
